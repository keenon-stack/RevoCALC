const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 260" role="img" aria-label="Revo Capital logo">
  <style>
...
export const EXPORT_LOGO_DATA_URL = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(
  LOGO_SVG
)}`;

export default EXPORT_LOGO_DATA_URL;
